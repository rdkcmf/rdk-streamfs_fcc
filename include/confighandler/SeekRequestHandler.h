...
namespace fcc {
class SeekRequestHandler : public ConfigHandlerMVarCb<ByteVectorType> {
public:
    explicit SeekRequestHandler(std::shared_ptr<StreamParser::TimeShiftBufferConsumer> tsbStreamParser,
