...
namespace fcc {
class StreamInfoRequestHandler : public ConfigHandlerMVarCb<ByteVectorType> {
public:
    explicit StreamInfoRequestHandler(MediaSourceHandler *mediaSourceHandler, streamfs::PluginCallbackInterface *cb);
...
public:
    ...
    StreamInfoRequestHandler() = delete;
