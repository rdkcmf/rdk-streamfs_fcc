...
namespace fcc {
class PlayerStateRequestHandler : public ConfigHandlerMVarCb<ByteVectorType> {
public:
    explicit PlayerStateRequestHandler(std::shared_ptr<StreamParser::TimeShiftBufferConsumer> tsbStreamParser,
...
public:
    ...
    PlayerStateRequestHandler() = delete;
